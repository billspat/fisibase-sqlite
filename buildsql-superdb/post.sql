...
DROP TABLE IF EXISTS `tblHyenas`;
DROP TABLE IF EXISTS `tblHyenasPerSession`;
DROP TABLE IF EXISTS `tblGreetings`;
DROP TABLE IF EXISTS `tblAggression_talek`; 
DROP TABLE IF EXISTS `tblLandmarks`; 
DROP TABLE IF EXISTS `tblPreyDensity`;
DROP TABLE IF EXISTS `tblRanks`;
DROP TABLE IF EXISTS `tblLocationsPerSession`;
...
-- ****** import aggressions data

.read buildsql-superdb/aggressions_import.sql

-- TO DO add cohort views, see doc folder



-- todo : tblDarting_talek "
